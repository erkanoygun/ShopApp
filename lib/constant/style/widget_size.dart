...
abstract class WidgetSize{
  static double heightSize15 = ScreenUtil().setHeight(15);
  static double heightSize18 = ScreenUtil().setHeight(18);
  static double heightSize22 = ScreenUtil().setHeight(22);
  static double heightSize25 = ScreenUtil().setHeight(25);
